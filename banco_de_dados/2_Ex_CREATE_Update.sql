...
-- Altere o e-mail do aluno CRIS para 'cristiano@fametro.com.br'
...
VALUES ('Java', 2, 1, 100), ('Php Básico', 1, 2, 90);
SELECT * FROM CURSO; 

UPDATE CURSO SET VALOR = VALOR * 1.1 
WHERE VALOR < 300;

UPDATE CURSO SET CURSO = 'Php Fundamentos' 
...
UPDATE ALUNO SET EMAIL = 'cristiano@fametro.com.br'
WHERE CODIGO = 1;
